builtin.module {
  "quantum.func"() ({
    ...
    %q2_53 = "quantum.OnQubit_controlled_phase"(%q1_2, %q2_49) {control_index = 1 : i32, target_index = 1 : i32, phase = -3.1415926535897931 : f64} : (vector<8xi1>, vector<8xi1>) -> vector<8xi1>
    ...
    %q2_60 = "quantum.OnQubit_controlled_phase"(%q1_2, %q2_57) {control_index = 2 : i32, target_index = 2 : i32, phase = -3.1415926535897931 : f64} : (vector<8xi1>, vector<8xi1>) -> vector<8xi1>
    ...
    %q2_66 = "quantum.OnQubit_controlled_phase"(%q1_2, %q2_64) {control_index = 3 : i32, target_index = 3 : i32, phase = -3.1415926535897931 : f64} : (vector<8xi1>, vector<8xi1>) -> vector<8xi1>
