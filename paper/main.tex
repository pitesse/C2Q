...
\begin{table*}[t]
  ...
  \begin{tabular}{lrrrrrr}
    ...
    Opt Showcase       & 3,274               & 1,502              & -54.1\%            & 2,051               & 552                & -73.1\%                 \\
    ...
    \midrule
  	extbf{Average}   &                     &                    & \textbf{-34.9\%}   &                     &                    & \textbf{-42.0\%}        \\
    \bottomrule
  \end{tabular}
\end{table*}
...
\textbf{Key Observations:}
	...
	extbf{1. Optimization Effectiveness:} The pipeline achieves 34.9\% average gate reduction and 42.0\% average depth reduction. 
...
reduction and 42.0\% depth reduction across 8 test cases. The iterative optimization strategy with phase 
