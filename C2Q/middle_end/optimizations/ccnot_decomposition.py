...
class CCnot_decomposition(RewritePattern):
    ...
    def match_and_rewrite(self, op: OnQubitCCnotOp, rewriter: PatternRewriter):
        ...
        cnot1 = rewriter.insert_op_before_matched_op(CNotOp.from_value(control2, h1.res))
        ...
        cnot2 = rewriter.insert_op_before_matched_op(CNotOp.from_value(control1, tdg1.res))
        ...
        cnot3 = rewriter.insert_op_before_matched_op(CNotOp.from_value(control2, t1.res))
        ...
        cnot4 = rewriter.insert_op_before_matched_op(CNotOp.from_value(control1, tdg2.res))
        self._propagate_name(tdg2.res, cnot4.res)
        
        cnot5 = rewriter.insert_op_before_matched_op(CNotOp.from_value(control1, control2))
        ...
        cnot6 = rewriter.insert_op_before_matched_op(CNotOp.from_value(control1, tdg3.res))
